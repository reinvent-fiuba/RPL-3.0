...
COPY rpl_users/extra_requirements.txt /tmp/rpl_users_extra_requirements.txt
COPY rpl_activities/extra_requirements.txt /tmp/rpl_activities_extra_requirements.txt
