...
from rpl_activities.src.deps.auth import (
    AllStudentsCourseUsersDependency,
...
@router.get(
    "/stats/courses/{courseId}/activities/me",
    response_model=ActivitiesStatsOfStudentDTO,
)
...
@router.get(
    "/stats/courses/{courseId}/submissions/me",
    response_model=SubmissionsStatsOfStudentDTO,
)
...
@router.get(
    "/stats/courses/{courseId}/submissions",
    response_model=SubmissionsStatsOfCourseDTO,
)
