...
def create_io_test_case(
    ...
    return TestsService(db).create_io_test_for_activity(
        current_course_user, course_id, activity_id, new_io_test_data
    )
...
def update_io_test_case(
    ...
    return TestsService(db).update_io_test_for_activity(
        current_course_user, course_id, activity_id, io_test_id, new_io_test_data
    )
...
def delete_io_test_case(
    ...
    return TestsService(db).delete_io_test_for_activity(
        current_course_user, course_id, activity_id, io_test_id
    )
...
def create_unit_tests(
    ...
    return TestsService(db).create_unit_test_suite_for_activity(
        current_course_user, course_id, activity_id, new_unit_tests_data
    )
...
def update_unit_tests(
    ...
    return TestsService(db).update_unit_test_suite_for_activity(
        current_course_user, course_id, activity_id, new_unit_tests_data
    )
