...
class Role(Base):
    ...
    course_users: Mapped[List["CourseUser"]] = relationship(back_populates="role", lazy="raise")

    def get_permissions(self) -> List[str]:
        """Get the permissions as a list of strings."""
        return [permission.strip() for permission in self.permissions.split(PERMISSION_DELIMITER)]
