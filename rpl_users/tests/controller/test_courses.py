...
def test_update_student_user_using_super_admin_user(
    users_api_client: TestClient,
    example_users,
    admin_auth_headers,
    regular_auth_headers,
...
def test_update_student_user_using_admin_user(
    users_api_client: TestClient,
    example_users,
    admin_auth_headers,
    regular_auth_headers,
...
def test_cannot_update_student_user_using_user_with_student_role_permissions(
    users_api_client: TestClient,
    email_handler,
    example_users,
    admin_auth_headers,
...
def test_cannot_update_user_to_non_existing_role(
    users_api_client: TestClient,
    email_handler,
    example_users,
    admin_auth_headers,
...
def test_cannot_update_user_to_non_existing_course(
    users_api_client: TestClient,
    email_handler,
    example_users,
    admin_auth_headers,
